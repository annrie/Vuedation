...
.ProductionNote__heading {
  @apply mx-auto my-0 max-w-1000px;
  font-size: em(30, 16);
  line-height: 1.73;
...
.ProductionNote__inner {
  @apply mx-0 mt-[60px] py-[80px] dark:bg-dark-50;
...
.Talk__title {
  @apply border-solid border-b-2 m-0 pb-4px;
  font-size: em(24, 16);
  font-weight: var(--FONT_WEIGHT_BASE_NORMAL);
  line-height: 1.6;
...
.Talk__subHeading {
  @apply m-0 pl-[16px] relative;
  font-size: em(16, 16);
  line-height: 1.625;
  font-weight: var(--FONT_WEIGHT_BASE_DEMIBOLD);

  &::before {
    @apply top-[5px] bottom-[5px] left-0 w-[4px] absolute content-empty;
